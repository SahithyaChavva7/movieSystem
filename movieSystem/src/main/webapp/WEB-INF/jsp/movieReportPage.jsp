        ...
        <tbody>
            <c:forEach items="${movieList}" var="movie">
                <tr>
                    ...
                    <td>
                        <a href="/movieDeletion/${movie.movieId}" target="_blank" class="btn btn-danger btn-custom">Delete Movie</a>
                    </td>
                    <td>
                        <a href="/updateMovie/${movie.movieId}" target="_blank" class="btn btn-warning btn-custom">Update Movie</a>
                    </td>
                    <td>
                        <a href="/updateMovieShow/${movie.movieId}" target="_blank" class="btn btn-info btn-custom">Update Show Time</a>
                    </td>
                </tr>
            </c:forEach>
        </tbody>
